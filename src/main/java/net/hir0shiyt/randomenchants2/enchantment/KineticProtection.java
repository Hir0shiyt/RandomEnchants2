...
public class KineticProtection extends Enchantment {
    ...
    public static void elytraDamage(LivingDamageEvent e) {
        if (e.getEntity() instanceof Player player) {
            ...
            if (EnchantUtils.hasEnch(elytra, ModEnchantments.KINETIC_PROTECTION)) {

                if (e.getEntityLiving().isFallFlying()) {
                    int enchLevel = EnchantmentHelper.getItemEnchantmentLevel(ModEnchantments.KINETIC_PROTECTION, elytra);
